...
describe Api::V1::ProductsController, type: :controller do
  ...
  describe 'when user has valid access token' do
    before { request.headers.merge!('SHOP_AUTH_TOKEN' => 'MY_AUTH') }
  ...
  describe 'when user has invalid access token' do
    describe 'GET index' do
      it 'returns http success' do
        get 'index', { format: :json }
      ...
      it 'should return all Products' do
        ...
        is_expected.to eql('message' => 'Please provide valid api token')
      end
    end
